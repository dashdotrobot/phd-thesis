...
\glsxtrnewsymbol[description={critical tension for rim buckling}]{Tc}{\ensuremath{T_c, \bar{T}_c, t_c}}
...
\glsxtrnewsymbol[description={critical external force to cause a single spoke to bucklek}]{Psb}{\ensuremath{P_{sb}}}
