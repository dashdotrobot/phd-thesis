...
% Coordinate system
\glsxtrnewsymbol[description={basis vectors of a cylindrical coordinate system at the rim centroid}]{ebasis}
...
\glsxtrnewsymbol[description={rotation of the rim cross-section about its normal vector}]{p}{\ensuremath{\phi}}
...
\glsxtrnewsymbol[description={spoke unit vector pointing from rim to hub}]{nvec}{\ensuremath{\mathbf{n}}}
...
\glsxtrnewsymbol[description={modal force vector}]{Fext}{\ensuremath{\mathbf{F}_{ext}}}
...
\glsxtrnewsymbol[description={non-dimensionalized ratio of spoke stiffness to rim stiffness}]{lr}{\ensuremath{\lambda_{ij}}}
