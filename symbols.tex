...
\glsxtrnewsymbol[description={denotes the part of the spoke stiffness proportional to $\gls{Espk}\gls{As}$}]{kmatl}{\ensuremath{()^{matl}}}
...
\newcommand{\matl}[1]{#1^{el}}
\newcommand{\geom}[1]{#1^{tens}}
