...
\glsxtrnewsymbol[description={vector displacement}]{uvec}{\ensuremath{\mathbf{u}}}
\glsxtrnewsymbol[description={displacement in the prestressed configuration}]{up}{\ensuremath{\mathbf{u}_p}}
\glsxtrnewsymbol[description={change in displacement from the pre-stressed configuration to the deformed configuration}]{du}{\ensuremath{\delta\mathbf{u}}}
\glsxtrnewsymbol[description={vector displacement of the rim shear center}]{usvec}{\ensuremath{\mathbf{u}_s}}
\glsxtrnewsymbol[description={vector components of shear center displacement}]{uvw}{\ensuremath{u,v,w}}
\glsxtrnewsymbol[description={rotation of rim cross-section about its normal vector}]{p}{\ensuremath{\phi}}


\glsxtrnewsymbol[description={rim axial stiffness}]{EArim}{\ensuremath{EA}}
\glsxtrnewsymbol[description={rim radial bending stiffness}]{EIrad}{\ensuremath{EI_1}}
\glsxtrnewsymbol[description={rim lateral bending stiffness}]{EIlat}{\ensuremath{EI_2}}
\glsxtrnewsymbol[description={rim torsional stiffness}]{GJ}{\ensuremath{GJ}}
