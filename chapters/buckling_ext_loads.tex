...
In order to compare the experimentally-determined radial strength with Equation \eqref{eq:P_c_nb}, it is necessary to determine the rim radius $\R$, the effective spoke axial stiffness $\gls{Espk}\gls{As}$, the lateral stiffness at zero spoke tension $K_{lat}^0$, the radial stiffness \gls{Krad}, and the critical buckling tension $\T_c$.
...
The radial stiffness is determined experimentally from the linear portion of the radial buckling experiments averaged over the three wheels tested, yielding $\gls{Krad}=\SI{1.98}{kN/mm}$.
