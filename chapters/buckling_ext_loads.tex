...
\caption{\textbf{(a)} Diameter measurement of the Sun-Ringle CR18 rim. \textbf{(b)} Centroid and shear center of a thin-walled C-channel beam \cite{Timoshenko1961}. \textbf{(b)} Assmumed location of the shear center of the CR18 rim cross-section.}
...
% ... Need to experimentally study effect of tension
% ... Lateral/radial failure envelope
% ... Post-buckling stiffness
% ... Characterize type of damage - certain rims types may be more susceptible to yield by lateral bending or torsion
