...
\begin{tabularx}{\textwidth}{p{1.2cm}Xcccc}
\hline\noalign{\smallskip}
\centering Smeared spokes & \centering Symmetry & Rim & Complexity & Analytical solution\\
\noalign{\smallskip}\hline\noalign{\smallskip}
\centering No  & \centering None & Monosymmetric$^{\rm a}$ & $\det()$ of 4Nx4N matrix & None\\
\centering Yes & \centering None & Monosymmetric & $\det()$ of 4x4 matrix & Impractical\\
\centering Yes & \centering Left-right $^{\rm b}$& Monosymmetric& Quadratic equation for $\bar{T}_c$ & Solution of \eqref{eq:Tc_quad}\\
\centering Yes & \centering Left-right& Bi-symmetric & Linear equation for $\bar{T}_c$ & \eqref{...}\\
\centering Yes & \centering Left-right, no spoke offset & Bi-symmetric & Linear equation for $\bar{T}_c$ & \eqref{...}\\
\noalign{\smallskip}\hline
\end{tabularx}
\raggedright$^{\rm a}$Monosymmetry implies $y_0\neq 0$\\
$^{\rm b}$The distance to the hub flange and spoke arrangement are identical on the left and right sides.
\end{table}
