...
\begin{equation}
\label{eq:Tc_crit}
\det{\left[\matl{\mathbf{K}_{rim}} + \matl{\mathbf{K}_{spokes}} + \Tb(\geom{\mathbf{K}_{spokes}} - \geom{\mathbf{K}_{rim}})\right]} = 0
\end{equation}
...
\det{\left[\matl{\mathbf{K}_{rim,n}} + \matl{\mathbf{\bar{K}}_{spokes,n}} + \Tb(\geom{\mathbf{\bar{K}}_{spokes,n}} - \geom{\mathbf{K}_{rim,n}})\right]} = 0
\end{equation}
...
\begin{multline}
\label{eq:Tc_quad}
\left(R^2\geom{\kuu}\yo - n^2R\yo \right)\Tb^2\\
-\left[\frac{\EIr}{R}\left(n^2 - 3n^4 \frac{\yo}{R} + R\geom{\kuu}\right)
       ...
       \left. +R\kpp (n^2 - R\geom{\kuu}) + 2R\yo\kup n^2 - R^2\kuu \yo \vphantom{\frac12} \right]\Tb\\
...
\begin{equation}
\Tb_{c,n} = \frac{1}{\pi}\left(\frac{1}{n^2 - R\geom{\kuu}}\right) K_n(\T=0)
\end{equation}
...
K_n(T) = K_n^{rim} + \pi \R (\matl{\kuu} + \Tb \geom{\kuu}) - \pi n^2 \Tb
\end{equation}
