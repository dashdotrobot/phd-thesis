...
Substituting definitions for dimensionless quantities $t,\m,\lr_{uu}$, we obtain a critical buckling tension which is independent of lateral bending stiffness, $\EIr$:
\begin{equation}
\label{eq:Tc_lo_mu}
