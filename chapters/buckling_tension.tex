...
Neglecting the radial/lateral spoke coupling terms ($\kuv=\kuw=\kvp=\kwp=0$) and second-order terms $\rx,\ry,\yo$, the buckling criterion \eqref{eq:Tc_crit_smeared} reduces to
\begin{multline}
\label{eq:Tc_quad}
-\yo\R\left(n^2 - \R\geom{\kuu}\right)\Tb^2\\
-\left[\frac{\EIl}{\R}\left(n^2 - \R\geom{\kuu} + n^4 \frac{\yo}{\R}\right)
       \frac{\widetilde{\GJ}n^2}{\R}\left(n^2 - \R\geom{\kuu} + \frac{\yo}{\R}(2n^2 - 1)\right) \right.\\
