...
The structural simplicity of the bicycle wheel makes finite-element analysis straightforward: the spokes and rim can be readily modeled with structural beam elements, and no delicate choices must be made regarding meshing, except to choose an appropriate discretization for the curvature of the rim.
...
\subsection{Optimization and design}
% Optimization
%   Keller
