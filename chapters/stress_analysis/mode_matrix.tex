...
Inserting the series approximations \eqref{eq:mm_FourierDef} into \eqref{eq:U_rim} and integrating yields a quadratic form for the strain energy in the rim:
\begin{equation}
\label{eq:mm_U_rim}
