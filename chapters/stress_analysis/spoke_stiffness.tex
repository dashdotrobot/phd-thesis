...
U_{spoke} &= \int_{\mathcal{S}_0}^{\mathcal{S}_d} \mathbf{f} \cdot d\mathbf{u}_n\\
          ...
          &= U_{spoke}^p + \mathbf{f}_p \cdot \delta\mathbf{u}_n + U_{spoke}^d
\end{split}
\end{align}
...
U_{spoke}^{d} = \frac{1}{2}(\delta\mathbf{u}_s \mathbf{k}_f \delta\mathbf{u}_s) +
...
\bar{U}_{spokes}^{pd} = \frac{1}{2}\int_0^{2\pi R} \mathbf{d}^T\, \mathbf{\bar{k}}\, \mathbf{d} \, ds
\end{equation}
