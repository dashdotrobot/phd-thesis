...
Equation \eqref{eq:U_rim} is derived with the help of the following relations:
\begin{gather}
...
\begin{equation}
\label{eq:U_rim}
U_{rim} = \int_0^{2\pi R} EA\varepsilon_c^2 + EI_1\kappa_1^2 + EI_2\kappa_2^2 + GJ\kappa_3^2 + EI_w(\kappa_3')^2 ds
\end{equation}
